...
class data_elements_class:
    ...
    def get_entries(self):
        ...
        self.entries_list = [FileName_Entry, eTrackingId_Entry, iTrackingId_Entry, sourceApplication_Entry,
                             sourceUser_Entry, tenantId_Entry, timestamp_Entry,
                             orderID_Entry, orderRef_Entry, planID_Entry, planItemID_Entry, processComponentID_Entry,
                             processComponentName_Entry,
                             processComponentVersion_Entry, originator_Entry, priority_Entry, actualProcessStep_Entry,
                             entity_Entry, operation_Entry, command_Entry]

        self.var_list = [self.dataElements["eTrackingId"]["entry"].get(),
                         self.dataElements["iTrackingId"]["entry"].get(),
                         self.dataElements["sourceApplication"]["entry"].get(),
                         self.dataElements["sourceUser"]["entry"].get(), self.dataElements["tenantId"]["entry"].get(),
                         self.dataElements["timestamp"]["entry"].get(),
                         self.dataElements["orderID"]["entry"].get(), self.dataElements["orderRef"]["entry"].get(),
                         self.dataElements["planID"]["entry"].get(),
                         self.dataElements["planItemID"]["entry"].get(),
                         self.dataElements["processComponentID"]["entry"].get(),
                         self.dataElements["processComponentName"]["entry"].get(),
                         self.dataElements["processComponentVersion"]["entry"].get(),
                         self.dataElements["originator"]["entry"].get(), self.dataElements["priority"]["entry"].get(),
                         self.dataElements["actualProcessStep"]["entry"].get(),
                         self.dataElements["entity"]["entry"].get(),
